...
class MarketForecastAdmin(admin.ModelAdmin):
    list_display = ('symbol', 'timeframe', 'trend_bias', 'confidence_score', 'current_price', 'projected_target_zone', 'recommended_action', 'updated_at')
    list_filter = ('trend_bias', 'recommended_action', 'timeframe', 'symbol')
